class GameOver {
    ...
    draw() {
        ...
        this.ctx.fillStyle = "rgb(153, 0, 0)"
        this.ctx.strokeText(`SCORE: ${this.score}`, 1000, 600 * this.fontRatio)
        this.ctx.fillText(`ENEMIES: ${this.enemies}`, 1000, 700 * this.fontRatio)
        this.ctx.fillText(`BOMBS: ${BOMBS_SHOOTED}`, 1000, 800 * this.fontRatio)
        this.ctx.fillText(`MISSILES: ${MISSILES_SHOOTED}`, 1000, 900 * this.fontRatio)
        this.ctx.fillText(`ENEMY SHOTS: ${ENEMY_SHOTS}`, 1000, 1000 * this.fontRatio)
